function ax = shadedErrorBaryy(x1,y1,er1,c1,yl1,yt1,x2,y2,er2,c2,yl2,yt2)
...
H(1) = shadedErrorBar(x1,y1,er1,'lineProps',c1);
b = figure('visible','off');
H(2) = shadedErrorBar(x2,y2,er2,'lineProps',c2);
...
set(ax(1),'YColor',c1,'YLim',yl1,'YTick',yt1);
set(ax(2),'YColor',c2,'YLim',yl2,'YTick',yt2);
